...
class Model {
    ...
    private static
    <Rover extends Domain.Rover<Rover>, Program extends Iterable<Instruction<Rover>>>
    Rover runProgram(Domain.PlateauView<Rover> grid, Rover currentRover, Program program) {
